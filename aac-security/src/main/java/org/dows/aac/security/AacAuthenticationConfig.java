...
public class AacAuthenticationConfig {
    ...
    // 未授权
    private final AacUnauthorizedEntryPoint aacUnauthorizedEntryPoint;
    // 拒绝
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        return http
                ...
                .authorizeHttpRequests(x -> x.requestMatchers(aacSettings.getWhitelist())
                                .permitAll()
...
//                                            Collection<? extends GrantedAuthority> authorities = authentication.get().getAuthorities();
                ...
                //没有登录 直接返回异常信息
                .exceptionHandling(x -> x.authenticationEntryPoint(aacUnauthorizedEntryPoint)
...
//                .authenticationProvider(aacUsernamePasswordAuthenticationProvider)
    ...
    public AuthenticationManager authenticationManager(AuthenticationConfiguration config, AccountApi accountApi) throws Exception {
        ...
        UsernamePasswordAuthenticationProvider usernamePasswordAuthenticationProvider =
                new UsernamePasswordAuthenticationProvider(userDetailsServiceHandler, passwordEncoder,aacSettings);
